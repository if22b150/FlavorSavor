...
class DataSeeder extends Seeder
{
    ...
    public function run() {
        ...
        DB::table('recipe_ingredient')->insert([['recipe_id' => '2'],['ingredient_id' => '1'],['text' => '1 EL'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '2'],['ingredient_id' => '2'],['text' => '2 Stk'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '2'],['ingredient_id' => '3'],['text' => '1 Brise'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '2'],['ingredient_id' => '4'],['text' => '50 g'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '2'],['ingredient_id' => '5'],['text' => '250 ml'],]);
        ...
        DB::table('recipe_ingredient')->insert([['recipe_id' => '3'],['ingredient_id' => '1'],['text' => '1 EL'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '3'],['ingredient_id' => '2'],['text' => '2 Stk'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '3'],['ingredient_id' => '3'],['text' => '1 Brise'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '3'],['ingredient_id' => '4'],['text' => '50 g'],]);
        DB::table('recipe_ingredient')->insert([['recipe_id' => '3'],['ingredient_id' => '5'],['text' => '250 ml'],]);
    }
}
